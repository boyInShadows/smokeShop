...
export default function BestsellersRail() {
  ...
  return (
    <section id="bestsellers" className="border-y border-border bg-surface/20">
        ...
        <div className="flex items-end justify-between gap-4">
          ...
          <div className="mb-8 hidden shrink-0 gap-2 sm:mb-10 sm:flex">
            <button
              ...
              className="grid h-11 w-11 place-items-center rounded-xl border border-border bg-surface text-text transition hover:border-secondary hover:text-secondary"
