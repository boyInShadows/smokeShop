...
export default function StoryBand() {
  return (
    <section id="story" className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:py-24">
      <div className="grid items-center gap-10 rounded-[var(--radius-card)] border border-border bg-surface/40 p-6 sm:p-10 lg:grid-cols-2 lg:gap-14 lg:p-14">
        {/* Visual */}
        <div className="smoke-bg relative order-last flex h-56 items-center justify-center rounded-2xl border border-border bg-surface-2 lg:order-first lg:h-80">
        ...
        {/* Copy */}
        <div>
          <span className="text-sm font-bold text-secondary">چرا ویپ اسموک؟</span>
          <h2 className="mt-2 text-2xl font-black sm:text-3xl lg:text-4xl">
            تجربهٔ خریدی مطمئن و حرفه‌ای
          </h2>
          <p className="mt-4 text-sm leading-relaxed text-muted sm:text-base">
            ما با تمرکز بر کیفیت و اصالت، تجربه‌ای متفاوت از خرید آنلاین محصولات ویپ
            ارائه می‌دهیم؛ از انتخاب محصول تا تحویل درب منزل، در کنار شما هستیم.
          </p>
          ...
          <a
            href="#bestsellers"
            className="glow-primary mt-8 inline-block rounded-xl bg-primary px-7 py-3 font-bold text-bg transition hover:bg-primary-strong"
          >
            شروع خرید
          </a>
        </div>
